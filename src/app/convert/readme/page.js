  ...
  return (
    <div>
      ...
      <div className="app-intro">
        ...
        <p>
          转换工具闲时基本不消耗什么，但是在转换过程需要大量的数据读取转换和写入，这些都是需要消耗大量CPU算力、运行内存进行频繁的文件IO操作，尤其是不少高产的跑友，几千条数据很正常的。在各种优化后仍无明显效果，只能选择改变转换工具的开放策略了——<a href="/pay"><b style={{color: 'red'}}>先打赏🍗后转换</b></a>。
        </p>
